...
<a class="twitter-timeline" href="https://twitter.com/2020visitnepal?ref_src=twsrc%5Etfw">Tweets by 2020visitnepal</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
```{r}
valueBox("14 Days", icon = "fa-bullseye",color = "brown")
```
